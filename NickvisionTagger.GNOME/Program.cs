...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added support for the following tag properties: BPM, Composer, Description, Publisher, ISRC</li><li>Added help documentation with yelp-tools, accessable from the Help menu action</li><li>Improved album art design and added support for managing back cover art and exporting album art</li><li>Fixed an issue where corrupted music files would crash the app. Now they will be skipped and a message will be logged through the console</li><li>Improved UI</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
