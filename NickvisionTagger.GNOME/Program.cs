...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added support for the BeatsPerMinute tag property</li><li>Fixed an issue where clearing a tag did not clear all fields</li><li>Fixed an issue where single album art from other programs was not read by Tagger</li><li>Empty Year, Track, and BPM fields will show an empty string instead of 0</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
