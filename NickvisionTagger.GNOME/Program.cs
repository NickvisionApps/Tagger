...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Version = "2023.7.1-beta3";
        _mainWindowController.AppInfo.Changelog = "<ul><li>Replaced taglib backend for tag metadata with atldotnet. This change added support for a lot more file types</li><li>Added support for the following tag properties: Composer, Description, Publisher</li><li>Added support for custom, user-defined properties</li><li>Added help documentation with yelp-tools, accessible from the Help menu action</li><li>Added more file sorting options</li><li>Improved album art design and added support for managing back cover art and exporting album art</li><li>Fixed an issue where corrupted music files would crash the app. Tagger will now display a dialog to warn the user of corrupted files</li><li>Improved UI</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
