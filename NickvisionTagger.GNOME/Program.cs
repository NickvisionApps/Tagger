...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Tagger has been completely rewritten in C#! With this new language comes better performance and more stable features. To signify this great change, we also updated the app icon (Thanks @daudix-UFO)!</li><li>There is now a separte option in Preferences for overwriting album art with MusicBrainz metadata independently of the overwritting tag data setting</li><li>Fixed an issue where some file types were not loading album art correctly</li><li>Improved UI/UX</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
