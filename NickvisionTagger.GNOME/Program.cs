...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added support for the following tag properties: BPM, Composer, Description, Publisher, ISRC</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
