...
public partial class Program
{
    ...
    public Program()
    {
        ...
        _mainWindowController.AppInfo.Changelog = "<ul><li>Added support for the BPM field</li><li>Fixed an issue where clearing a tag did not clear all feilds</li><li>Empty Year, Track, and BPM fields will show an empty string instead of 0</li><li>Updated translations (Thanks everyone on Weblate!)</li></ul>";
